...
while true; do
  ...
  case "${choice}" in
    ...
    9)  run_script "${SCRIPTS_DIR}/audit_fix.sh" "Audit & Fix" ;;
    10) run_script "${SCRIPTS_DIR}/fix_all_peers.sh" "Fix Peer Deps" ;;
    ...
    17) run_script "${SCRIPTS_DIR}/reinstall_deps.sh" "Reinstall All Dependencies" ;;
    ...
    19) run_script "${SCRIPTS_DIR}/auto_rebase_all.sh" "Auto-Rebase All" ;;
    20) run_script "${SCRIPTS_DIR}/bump_dependencies_all.sh" "Bump Dependencies" ;;
