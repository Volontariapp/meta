...
build_dynamic_workspace() {
  local bin="$1"
  PROJECT_REPOS=("api-gateway" "ms-user" "ms-social" "ms-post" "ms-event" "ms-storage" "nativapp" "npm-packages" "outbox-runners" "workers-runners" "proto-registry" "ci-tools" "deploy" "changelog-checker" "post-processors-runner")
  REPOS=()
